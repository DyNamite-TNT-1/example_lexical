...
/**
 * This is forked from "@lexical/react/LexicalCheckListPlugin (v0.17.0)" to replace func `calculateZoomLevel` with constant `zoomLevel`.
 *
 * Func `calculateZoomLevel` is wrong on MacOS.
 */
export function MyCheckListPlugin(): null {
...
function handleCheckItemEvent(event: PointerEvent, callback: () => void) {
  ...
  const pageX = event.pageX / zoomLevel;
  if (
    target.dir === "rtl"
